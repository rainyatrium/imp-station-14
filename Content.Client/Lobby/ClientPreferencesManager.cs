...
namespace Content.Client.Lobby
{
    ...
    public sealed class ClientPreferencesManager : IClientPreferencesManager
    {
        ...
        {
            Preferences = new PlayerPreferences(Preferences.Characters, slot, Preferences.AdminOOCColor, Preferences.OOCColor);
        ...
        public void UpdateCharacter(ICharacterProfile profile, int slot)
        {
            ...
            Preferences = new PlayerPreferences(characters, Preferences.SelectedCharacterIndex, Preferences.AdminOOCColor, Preferences.OOCColor);

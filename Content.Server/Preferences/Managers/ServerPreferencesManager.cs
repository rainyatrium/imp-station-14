...
namespace Content.Server.Preferences.Managers
{
    ...
    public sealed class ServerPreferencesManager : IServerPreferencesManager, IPostInjectInit
    {
        ...
        private async void HandleSelectCharacterMessage(MsgSelectCharacter message)
        {
            ...
            prefsData.Prefs = new PlayerPreferences(curPrefs.Characters, index, curPrefs.AdminOOCColor, curPrefs.ConstructionFavorites, curPrefs.OOCColor);
        ...
        public async Task SetProfile(NetUserId userId, int slot, ICharacterProfile profile)
        {
            ...
            prefsData.Prefs = new PlayerPreferences(profiles, slot, curPrefs.AdminOOCColor, curPrefs.ConstructionFavorites, curPrefs.OOCColor);
        ...
        public async Task SetConstructionFavorites(NetUserId userId, List<ProtoId<ConstructionPrototype>> favorites)
        {
            ...
            var curPrefs = prefsData.Prefs!;
            prefsData.Prefs = new PlayerPreferences(curPrefs.Characters, curPrefs.SelectedCharacterIndex, curPrefs.AdminOOCColor, favorites, curPrefs.OOCColor);
        ...
        private async void HandleDeleteCharacterMessage(MsgDeleteCharacter message)
        {
            ...
            prefsData.Prefs = new PlayerPreferences(arr, nextSlot ?? curPrefs.SelectedCharacterIndex, curPrefs.AdminOOCColor, curPrefs.ConstructionFavorites, curPrefs.OOCColor);
        ...
        private async void HandleUpdateConstructionFavoritesMessage(MsgUpdateConstructionFavorites message)
        {
            ...
            var curPrefs = prefsData.Prefs!;
            prefsData.Prefs = new PlayerPreferences(curPrefs.Characters, curPrefs.SelectedCharacterIndex, curPrefs.AdminOOCColor, validatedList, curPrefs.OOCColor);
        ...
        private PlayerPreferences SanitizePreferences(ICommonSession session, PlayerPreferences prefs, IDependencyCollection collection)
        {
            ...
            }), prefs.SelectedCharacterIndex, prefs.AdminOOCColor, prefs.ConstructionFavorites, prefs.OOCColor);
        }
